...
ALTER TABLE banking.banks ADD COLUMN status bank_status NOT NULL DEFAULT 'active';
...
ALTER TABLE banking.bank_accounts ADD COLUMN status bank_account_status NOT NULL DEFAULT 'active';
...
ALTER TABLE banking.currencies ADD COLUMN status currency_status NOT NULL DEFAULT 'active';
