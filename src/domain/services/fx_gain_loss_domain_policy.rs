//! Domain policy for FxGainLoss aggregate
//!
...
/// Domain policy for FxGainLoss — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<FxGainLoss>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type FxGainLossDomainPolicy = PermitAllPolicy<FxGainLoss>;
