//! Specifications for BankAccount aggregate
//!
...
// Each predicate implements `Specification<BankAccount>` and can be combined
...
//
// pub struct ActiveBankAccountSpec;
// impl Specification<BankAccount> for ActiveBankAccountSpec {
//     fn is_satisfied_by(&self, e: &BankAccount) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
