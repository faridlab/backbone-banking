//! Specifications for BankStatementImport aggregate
//!
...
// Each predicate implements `Specification<BankStatementImport>` and can be combined
...
//
// pub struct ActiveBankStatementImportSpec;
// impl Specification<BankStatementImport> for ActiveBankStatementImportSpec {
//     fn is_satisfied_by(&self, e: &BankStatementImport) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
