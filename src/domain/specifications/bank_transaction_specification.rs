//! Specifications for BankTransaction aggregate
//!
...
// Each predicate implements `Specification<BankTransaction>` and can be combined
...
//
// pub struct ActiveBankTransactionSpec;
// impl Specification<BankTransaction> for ActiveBankTransactionSpec {
//     fn is_satisfied_by(&self, e: &BankTransaction) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
