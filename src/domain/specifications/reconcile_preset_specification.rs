//! Specifications for ReconcilePreset aggregate
//!
...
// Each predicate implements `Specification<ReconcilePreset>` and can be combined
...
//
// pub struct ActiveReconcilePresetSpec;
// impl Specification<ReconcilePreset> for ActiveReconcilePresetSpec {
//     fn is_satisfied_by(&self, e: &ReconcilePreset) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
