//! Specifications for FxGainLoss aggregate
//!
...
// Each predicate implements `Specification<FxGainLoss>` and can be combined
...
//
// pub struct ActiveFxGainLossSpec;
// impl Specification<FxGainLoss> for ActiveFxGainLossSpec {
//     fn is_satisfied_by(&self, e: &FxGainLoss) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
