//! Specifications for ExchangeRate aggregate
//!
...
// Each predicate implements `Specification<ExchangeRate>` and can be combined
...
//
// pub struct ActiveExchangeRateSpec;
// impl Specification<ExchangeRate> for ActiveExchangeRateSpec {
//     fn is_satisfied_by(&self, e: &ExchangeRate) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
