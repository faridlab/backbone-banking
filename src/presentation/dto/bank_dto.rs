...
pub struct CreateBankDto {
    ...
    pub name: String,
    #[cfg_attr(feature = "validation", validate(length(max = 11)))]
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "swift_bic")]
...
pub struct PatchBankDto {
    ...
    #[cfg_attr(feature = "validation", validate(length(max = 11)))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "swift_bic")]
    pub swift_bic: Option<String>,
    #[cfg_attr(feature = "validation", validate(length(max = 2)))]
    #[cfg_attr(feature = "openapi", schema(example = "example"))]
    #[serde(skip_serializing_if = "Option::is_none")]
